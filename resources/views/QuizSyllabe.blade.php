...
<form class="col s8 offset-s2">
           ...
           <input type="hidden" id="message" class="materialize-textarea" value="la syllabe manquante"></input>
...
<div id="modal1" class="modal">
  <div class="action-bar">
    ...
    <center>
    <a class="btn btn-success" href="{{route('ColerQuiz')}}">Home</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a class="btn btn-success" href="{{route('testQuizAppel')}}">Next</a>
    </center>
    ...
    <script >
        ...
        //*****************************************************************************
        var question1 = {
            qImg: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR28VMUsefnthaxTeJ8KXnbwpG34sWD10Yrtg&usqp=CAU",
            question: "la syllabe manquante ??",
            answers: ["as", "us", "is "],
            correct: 1
            };
