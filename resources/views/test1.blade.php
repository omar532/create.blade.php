...
@section('content')
    <style>
        ...
        .indicator.incorrect {
            background: url('f.png') no-repeat center;
            border-color: #fb0f1b;
        }
        #game-end-times-up {
            display: none;
                        ...
                        <div id="game">
                            <div class="game-grid">
                                ...
                                <div class="game-left-col">
                                    <div class="gauge-container" style="background: #ffffff url('icon_01.svg.png') no-repeat center center; background-size: 100px 100px;">
