...
@section('content')
    ...
    <style>
        ...
        .back{
            background-image:url('https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto,q_auto,f_auto/gigs/187050630/original/598af8c697acf9d8a434a09ac9d069cceef76ca7/provide-you-with-games-and-quiz-for-your-kids-students.jpg');
    ...
    <script>
        ...
        function showProgress() {
            ...
            if(currentQuestionNumber==1){
                ...
                img.src = "https://www.quizz.biz/uploads/quizz/902497/1_Q8tM7.jpg";
        ...
        var questions = [
            new Question("Où se trouve la tour Eiffel ?", [" En Allemagne", "En France","À Londres"],"En France"),
            new Question("Où se trouve le Big Ben ?", ["En France", "À Londres", "En France"],"À Londres"),
            ...
            new Question("Combien font 5x5 ?", ["15", "25", "10"], "25")
        ];
        // create quiz
